...
//        attributes.addElement(POSSESSIVE_FEATURE);
        ...
        FastVector propertyName = new FastVector(45);
        ...
        propertyName.addElement("child");
        propertyName.addElement("owner");
        propertyName.addElement("instrument");
        propertyName.addElement("influences");
        propertyName.addElement("place");
        propertyName.addElement("live");
        propertyName.addElement("musicComposer");
        propertyName.addElement("combatant");
        propertyName.addElement("capital");
        propertyName.addElement("leader");
        propertyName.addElement("editing");
        propertyName.addElement("doctoralAdvisor");
        propertyName.addElement("imports");
        propertyName.addElement("office");
        propertyName.addElement("residence");
        propertyName.addElement("producer");
        propertyName.addElement("knownFor");
        propertyName.addElement("workInstitutions");
        propertyName.addElement("officialLanguage");
        propertyName.addElement("architect");
        propertyName.addElement("artist");
        propertyName.addElement("commander");
        propertyName.addElement("governor");
        propertyName.addElement("productionCompany");
        propertyName.addElement("academicDiscipline");
        propertyName.addElement("chancellor");
        propertyName.addElement("city");
