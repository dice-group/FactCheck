...
<<<<<<< HEAD:factcheck-core/src/main/java/org/aksw/defacto/search/cache/solr/Solr4SearchResultCache.java
...
=======
    ...
    public boolean contains(String identifier) {
        ...
        SolrQuery query = new SolrQuery(Constants.LUCENE_SEARCH_RESULT_QUERY_FIELD + ":\"" + identifier + "\"").setRows(1);
>>>>>>> master:factcheck-core/src/main/java/org/aksw/defacto/search/cache/solr/Solr4SearchResultCache.java
